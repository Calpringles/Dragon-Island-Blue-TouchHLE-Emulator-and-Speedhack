...
- (())setRootViewController:(id)view_controller { // UIViewController*
    ...
    // Mount the controller's view to fill the window, reusing addSubview:'s
    // view-controller path (viewWill/DidAppear + autorotation).
